	...
	return [
		{
			...
			children: (
				<>
					...
					<p>
						Vor einem produktiven Einsatz müssen Betreiberangaben,
						Hosting-Details und rechtliche Pflichtangaben konkret ergänzt und
						geprüft werden.
					</p>
				</>
			),
		},
		{
			...
			children: (
				<p>
					Verantwortlich ist der Betreiber dieser RoomFull-Instanz. Die
					konkreten Kontaktdaten sollten hier vor dem Livegang ergänzt werden.
				</p>
			),
		},
		{
		...
		},
		{
			...
			children: (
				<p>
					...
					anzuzeigen und Admins die operative Verwaltung aktiver Units und
		...
		},
		{
			...
			children: (
				<p>
					Account- und Buchungsdaten werden so lange gespeichert, wie sie für
					den Betrieb des MVP und die Nachvollziehbarkeit von Buchungen
					erforderlich sind. Konkrete Löschfristen sollten vor dem Livegang
					festgelegt werden.
				</p>
			),
		},
		{
			...
			children: (
				<>
					...
					<p>
						Für produktive Systeme sollte hier zusätzlich ein konkreter
						Kontaktweg und die zuständige Datenschutzaufsicht genannt werden.
					</p>
				</>
			),
		},
		{
			...
			children: (
				<p>
					...
					die <Link href={appRoutes.faq(locale)}>FAQ-Seite</Link>.
				</p>
			),
		},
	];
